...
public class App
{
    ...
    public static final String STUDENT_MAIN_VIEW = "student";
    public static final String PROMOTER_MAIN_VIEW = "promoter";
    public static final String ADMIN_MAIN_VIEW = "admin";
